        ...
        <div class="modal-dialog">
          <div class="modal-content bg-dark">
            <div class="modal-header bg-dark">
              <h4 class="modal-title text-white">Créer un Tableau</h4>
              ...
              <form style="margin-left: 10px;" method="POST">
                ...
                <div class="row">
                  ...
                  <div class="modal-footer" style="margin-left: 10px;">
                    <input type="submit" name="boutonCreation" class="btn btn-success boutonCreation"></input>
                    <button type="button" name="boutonQuitter" class="btn btn-danger" data-dismiss="modal">Fermer</button>
                  </div>
              </form>
              <?php $tableau->creationTableau(); ?>
